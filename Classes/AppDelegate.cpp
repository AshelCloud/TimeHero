...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
		...
		//glview = GLViewImpl::createWithFullScreen("TimeHero");
		glview = GLViewImpl::createWithRect("TimeHero", cocos2d::Rect(0, 0, smallResolutionSize.width, smallResolutionSize.height));
#else
        glview = GLViewImpl::create("TimeHero");
#endif
